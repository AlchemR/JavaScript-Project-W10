...
window.onload = function () {
  ...
  intro3button.addEventListener('click', () => { ; intro3.style.display = 'none'; intro4.style.display = 'block'; intro4button.style.display = 'block';  })
  intro4button.addEventListener('click', () => { ; intro4button.style.display = 'none'; level1flag.style.display = 'block'; startbutton.style.display = 'block'; intro4.classList.add("flip-card-active"); })
